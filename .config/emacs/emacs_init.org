  ...
  #+BEGIN_SRC emacs-lisp
    ...
    (pcase system-type
     ((or 'gnu/linux 'cygwin)
      ...
      (set-face-attribute 'default nil :font "IosevkaTerm Nerd Font" :height 80 :weight 'normal)
      )
     ('windows-nt
      ;;(set-face-attribute 'default nil :font "Fira Code Retina" :height 100)
      (set-face-attribute 'default nil :font "IosevkaTerm Nerd Font" :height 100 :weight 'normal)
      ))
